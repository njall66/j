NB. see - https://github.com/tangentstorm/j-kvm/blob/work/vt.ijs
...
w_rkey =: {{
  while. 1 do.
    ...
    NB. smoutput r;h;b;n0;nr
    if. *{.nr do.
      dn=. 2{b
      'rc kc sc ch' =. 4{.4}.b
      ch =. ch{a.
      mod =. '.x'{~_32{.!.0#: 65536 65536 #. _2{.b
      NB. smoutput 'dn:';dn;'rc:';rc;'kc:';kc;'ch:';ch;'mod:';mod;'b';b
      NB. skip over modifier keys
      if. dn > kc e. 16 17 18 do. (< 4&}. b) ,~ <a.i.ch return. end.
    end.
  end. }}
